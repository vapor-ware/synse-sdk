...
type simpleTestConfig struct {
	Version            int
	TestField          string
	BadAddedInTag      string
	BadDeprecatedInTag string
	BadRemovedInTag    string
}
...
func (config *simpleTestConfig) GetVersion() int {
...
func (config *complexTestConfig) GetVersion() int {
	return config.Version
}
